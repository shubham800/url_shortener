                    ...
                    <table class="w-full border border-gray-200 rounded-lg overflow-hidden">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-sm font-semibold text-gray-700">Company</th>
                                <th class="px-6 py-3 text-sm font-semibold text-gray-700">Created By</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($urls as $url)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-3" style="text-align: center;">{{ $url->company->name }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="6" class="px-6 py-4 text-center text-gray-500" style="text-align: center;">
                                        No URLs found
                                    </td>
                                </tr>
                            @endforelse
